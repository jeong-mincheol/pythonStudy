...
with col2:
    input_sdate = st.text_input(label = '시작날짜', placeholder='예) 20250101' )

with col3:
    input_edate = st.text_input(label = '종료날짜', placeholder='예) 20250101' )

if st.button("조회"):
    if input_code != "" and input_sdate != "" and input_edate != "":
